...
class GroupApi
{
     ...
     * @param double $groupid  (required)
     * @return \DBCDK\CommunityServices\Model\InlineResponse200
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupCreateFlag($description, $profileid, $groupid)
    {
        list($response, $statusCode, $httpHeader) = $this->groupCreateFlagWithHttpInfo ($description, $profileid, $groupid);
        return $response; 
    }


    /**
     * groupCreateFlagWithHttpInfo
     *
     * Flag a group
     *
     * @param string $description  (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupCreateFlagWithHttpInfo($description, $profileid, $groupid)
    {
        
        // verify the required parameter 'description' is set
        if ($description === null) {
            throw new \InvalidArgumentException('Missing the required parameter $description when calling groupCreateFlag');
        }
        // verify the required parameter 'profileid' is set
        if ($profileid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $profileid when calling groupCreateFlag');
        }
        // verify the required parameter 'groupid' is set
        if ($groupid === null) {
            throw new \InvalidArgumentException('Missing the required parameter $groupid when calling groupCreateFlag');
        }
  
        // parse inputs
        $resourcePath = "/Groups/createFlag";
        $resourcePath = str_replace("{format}", "json", $resourcePath);
        $method = "POST";
        $httpBody = '';
        $queryParams = array();
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeExistsFlags($fk, $id)
    {
        list($response, $statusCode, $httpHeader) = $this->groupPrototypeExistsFlagsWithHttpInfo ($fk, $id);
        return $response; 
    }


    /**
     * groupPrototypeExistsFlagsWithHttpInfo
     *
     * Check the existence of flags relation to an item by id.
     *
     * @param string $fk Foreign key for flags (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeExistsFlagsWithHttpInfo($fk, $id)
    {
        
        // verify the required parameter 'fk' is set
        if ($fk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fk when calling groupPrototypeExistsFlags');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling groupPrototypeExistsFlags');
        }
  
        // parse inputs
        $resourcePath = "/Groups/{id}/flags/rel/{fk}";
        $resourcePath = str_replace("{format}", "json", $resourcePath);
        $method = "HEAD";
        $httpBody = '';
        $queryParams = array();
    ...
    /**
     * groupPrototypeLinkFlags
     *
     * Add a related item by id for flags.
     *
     * @param string $fk Foreign key for flags (required)
     * @param string $id PersistedModel id (required)
     * @param \DBCDK\CommunityServices\Model\GroupFlag $data  (optional)
     * @return \DBCDK\CommunityServices\Model\GroupFlag
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeLinkFlags($fk, $id, $data = null)
    {
        list($response, $statusCode, $httpHeader) = $this->groupPrototypeLinkFlagsWithHttpInfo ($fk, $id, $data);
        return $response; 
    }


    /**
     * groupPrototypeLinkFlagsWithHttpInfo
     *
     * Add a related item by id for flags.
     *
     * @param string $fk Foreign key for flags (required)
     * @param string $id PersistedModel id (required)
     * @param \DBCDK\CommunityServices\Model\GroupFlag $data  (optional)
     * @return Array of \DBCDK\CommunityServices\Model\GroupFlag, HTTP status code, HTTP response headers (array of strings)
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeLinkFlagsWithHttpInfo($fk, $id, $data = null)
    {
        
        // verify the required parameter 'fk' is set
        if ($fk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fk when calling groupPrototypeLinkFlags');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling groupPrototypeLinkFlags');
        }
        ...
        try {
            list($response, $statusCode, $httpHeader) = $this->apiClient->callApi(
                $resourcePath, $method,
                $queryParams, $httpBody,
                $headerParams, '\DBCDK\CommunityServices\Model\GroupFlag'
            );
            ...
            return array($this->apiClient->getSerializer()->deserialize($response, '\DBCDK\CommunityServices\Model\GroupFlag', $httpHeader), $statusCode, $httpHeader);
            
        } catch (ApiException $e) {
            switch ($e->getCode()) { 
            case 200:
                $data = $this->apiClient->getSerializer()->deserialize($e->getResponseBody(), '\DBCDK\CommunityServices\Model\GroupFlag', $e->getResponseHeaders());
                $e->setResponseObject($data);
                break;
            }
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeUnlinkFlags($fk, $id)
    {
        list($response, $statusCode, $httpHeader) = $this->groupPrototypeUnlinkFlagsWithHttpInfo ($fk, $id);
        return $response; 
    }


    /**
     * groupPrototypeUnlinkFlagsWithHttpInfo
     *
     * Remove the flags relation to an item by id.
     *
     * @param string $fk Foreign key for flags (required)
     ...
     * @throws \DBCDK\CommunityServices\ApiException on non-2xx response
     */
    public function groupPrototypeUnlinkFlagsWithHttpInfo($fk, $id)
    {
        
        // verify the required parameter 'fk' is set
        if ($fk === null) {
            throw new \InvalidArgumentException('Missing the required parameter $fk when calling groupPrototypeUnlinkFlags');
        }
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling groupPrototypeUnlinkFlags');
        }
